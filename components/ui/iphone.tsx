  ...
  return (
    ...
    >
      {children && (
        ...
        >
          <div className="h-full w-full scrollbar-none overflow-y-auto [&::-webkit-scrollbar]:hidden">
            {children}
          </div>
        </div>
      )}
      ...
      >
        ...
        <path
          d="M249 48.5C249 42.701 253.701 38 259.5 38C265.299 38 270 42.701 270 48.5C270 54.299 265.299 59 259.5 59C253.701 59 249 42.701 249 48.5Z"
          className="fill-[#F5F5F5] dark:fill-[#262626]"
        />
